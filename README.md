...
Upon first installation, 4 new colours are available to replace the incipid ones included in the existing firmware.  A config file is created on the internal storage under COL\colours.cfg.  You can edit the 4 colours and re-run the installer to change them.  Instructions can be found in the config file after first use.
